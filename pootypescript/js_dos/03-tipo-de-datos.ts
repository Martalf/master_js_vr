...
let cadena: alfanumerico = 'martalf@gmail.com';
...
let cualquiera: any = false;

//arrays

var lenguajes: Array<string> = ['PHP', 'Javascript', 'JAVA'];

let years: number[] = [12,3,4,5];
...
if(numero_1 = 10){
	...
	let numero_1 = 5;   // no redefine porque solo actua a nivel de bloque
